...
async def updates(ctx):
    ...
    await asyncio.sleep(4)
    await bot.edit_message(m1,new_content='<a:alert:557215953839194123> We beleive at iCodeTM that we think its the best thing to do is shutdown Graphiq. We may change bot names but we think its for the best that we should shutdown Graphiq.')
