...
async def help_rules(ctx):
    ...
    embed.add_field(name=":black_small_square: No Copying of scripts via Discord or GitHub", value=" ",inline=True)
    embed.add_field(name=":black_small_square: No illigal material should be added.", value=" ",inline=True)
    embed.add_field(name=":black_small_square: No spamming of the bot.", value=" ",inline=True)
    embed.add_field(name=":black_small_square: No raiding of the bot.", value=" ",inline=True)
