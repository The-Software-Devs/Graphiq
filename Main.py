...
async def on_command_error(error, ctx):
	if isinstance(error, commands.CommandNotFound):
		...
		draw.text((10, 130), "Or this command doesn't exist.", (255, 255, 255), font=font)
		draw.text((10, 150), "See if the command exists by doing b.help.", (255, 255, 255), font=font)
		draw.text((10, 200), "Graphiq©", (255, 255, 255), font=font)
