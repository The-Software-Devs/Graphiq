...
async def stats(ctx):
	...
	embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/536467416390041627/543164779007574036/SPOILER_unknown.png")
	embed.set_footer(text=" | {}".format(bot.user.name), icon_url="https://cdn.discordapp.com/attachments/536467416390041627/543164779007574036/SPOILER_unknown.png")
	await bot.say(embed=embed)
	channel = bot.get_channel('532949494036168706')
