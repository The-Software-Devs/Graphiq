...
async def on_command_error(error, ctx):
	if isinstance(error, commands.CommandNotFound):
		...
		draw.text((10, 150), "Or this command doesn't exist.", (255, 255, 255), font=font)
		draw.text((10, 180), "See if the command exists by doing b.help.", (255, 255, 255), font=font)
		draw.text((10, 350), "Graphiq. 2019", (255, 255, 255), font=font)
